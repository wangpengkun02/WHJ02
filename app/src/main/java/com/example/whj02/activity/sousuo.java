...
import com.example.whj02.liushi.FlowLayout;
import com.example.whj02.liushi.RecordSQLiteOpenHelper;
    ...
    private void initListener() {
        ...
        tvSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(sousuo.this,SouSuoHou.class);
...
//           //保存按下能显示selector的效果，需要设置一个如下的属性
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(sousuo.this, "" + searchContent, Toast.LENGTH_SHORT).show();
                    etSearch.setText("");
                }
            });
        }
